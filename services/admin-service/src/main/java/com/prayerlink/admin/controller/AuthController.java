...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody Map<String, String> body, HttpServletResponse response) {
        ...
        if (adminOpt.isPresent()) {
            ...
            if (passwordEncoder.matches(password, admin.getPasswordHash())) {
                String token = jwtUtil.generateToken(
                        admin.getAdminId(), admin.getUsername(), admin.getRole(), admin.getGroupId());
                ...
                respBody.put(
                        "groupId",
                        admin.getGroupId() != null ? admin.getGroupId().toString() : "");
        ...
        Optional<IntercessorAccount> intercessorOpt =
                intercessorAccountRepository.findById(cleanIdentifier.toLowerCase());
