...
public class Group {
    ...
    public static final TableSchema<Group> SCHEMA = StaticTableSchema.builder(Group.class)
            ...
            .addAttribute(
                    String.class, a -> a.name("name").getter(Group::getName).setter(Group::setName))
            .addAttribute(
                    String.class,
                    a -> a.name("description").getter(Group::getDescription).setter(Group::setDescription))
            .addAttribute(
                    String.class,
                    a -> a.name("passcode")
            ...
            .addAttribute(
                    Boolean.class,
                    a -> a.name("optOutGeneral").getter(Group::getOptOutGeneral).setter(Group::setOptOutGeneral))
            .addAttribute(
                    Instant.class,
                    a -> a.name("createdAt").getter(Group::getCreatedAt).setter(Group::setCreatedAt))
            .build();
