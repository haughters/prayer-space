...
public class GroupCoverageTest {
    ...
    void testModels() {
        ...
        Group g = Group.builder()
                ...
                .build();
        assertEquals(UUID.fromString("00000000-0000-0000-0000-000000000001"), g.getGroupId());
        ...
        Group g2 = new Group();
        g2.setGroupId(UUID.fromString("00000000-0000-0000-0000-000000000002"));
        assertEquals(UUID.fromString("00000000-0000-0000-0000-000000000002"), g2.getGroupId());
        ...
        GroupMember gm = GroupMember.builder()
                ...
                .addedAt(Instant.now())
                .build();
        assertEquals(UUID.fromString("00000000-0000-0000-0000-000000000001"), gm.getGroupId());
        assertEquals(UUID.fromString("00000000-0000-0000-0000-000000000002"), gm.getMemberId());
    ...
    void testApplicationMain() {
        ...
        try {
            ...
            // may fail if aws-serverless-java-container throws when run outside Lambda, but will cover the
